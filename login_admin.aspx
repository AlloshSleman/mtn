<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login_admin.aspx.cs" Inherits="Aspx.login_admin" %>
...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1 class="text-light"><a href="#"><span>فوترة</span></a></h1>
      </div>
          ...
          <div class="col-lg-12 pt-4 pt-lg-0 content">
            <div class="php-email-form">
              <div class="form-group mt-3 mb-3">
                ...
                <asp:TextBox runat="server" type="text" class="form-control" name="email" id="login_username"/>
              </div>
              <div class="form-group mt-3 mb-3">
                <label for="password">كلمة المرور</label>
                <asp:TextBox runat="server"  type="password" class="form-control" name="password" id="login_password"/>
              </div>
              <div class="text-center"><asp:Button  runat="server" ID="login" OnClick="login_Click" style="background: #fff;
                background-color: #4e2ae0;
                padding: 10px 24px;
                color: white;
                transition: 0.4s;" type="submit" Text="تسجيل دخول"/></div>
            </div>
          </div>
        </div>
      </div>
